...
class RegisterVacancyRequestCard extends ConsumerStatefulWidget {
  ...
  const RegisterVacancyRequestCard({
    super.key,
  ...
  @override
  ConsumerState<RegisterVacancyRequestCard> createState() =>
      _RegisterVacancyRequestCardState();
}

class _RegisterVacancyRequestCardState
    extends ConsumerState<RegisterVacancyRequestCard> {
