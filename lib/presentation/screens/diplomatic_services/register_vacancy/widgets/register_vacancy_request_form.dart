...
class RegisterVacancyRequestForm extends ConsumerWidget {
  final _VSControllerParams params;

  // final _ViewState state;
  // final _VSController stateController;
  const RegisterVacancyRequestForm({
    super.key,
    // required this.state,
...
class RegisterVacancyRequestHeader extends StatelessWidget {
  final String title;
  final String subtitle;
  final VoidCallback? onClose;

  const RegisterVacancyRequestHeader({
    super.key,
