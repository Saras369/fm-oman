...
part 'widgets/register_vacancy_request_card.dart';
part 'widgets/register_vacancy_request_form.dart';

@RoutePage()
class RegisterVacancyScreen extends ConsumerWidget {
  final List<SubServices> subServicesList;
  final int serviceId;
  late final _VSControllerParams params;

  RegisterVacancyScreen({
    super.key,
