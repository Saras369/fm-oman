...
class _ViewState {
  ...
  final List<ClubCardDiplomaticTitleItem> diplomaticTitles;
  ...
  _ViewState({
    ...
    required this.diplomaticTitles,
  });
  ...
  _ViewState copyWith({
    ...
    List<ClubCardDiplomaticTitleItem>? diplomaticTitles,
  }) {
    return _ViewState(
      ...
      diplomaticTitles: diplomaticTitles ?? this.diplomaticTitles,
    );
  }
}
...
class _VSController extends StateNotifier<_ViewState> {
  ...
  final List<String> requestFor = ['Employee', 'Non Employee'];
  final List<String> membershipType = ['Single', 'Family'];
  ...
  void onPressRequestMenuActionItem() {
    KAppX.extendedRouter.dialog.showKDialog(
      ...
      builder: (context) {
        return DiplomaticClubCardRequestForm(params: params);
      },
    );
  }
