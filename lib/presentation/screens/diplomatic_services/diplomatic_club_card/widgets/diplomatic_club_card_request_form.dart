...
class DiplomaticClubCardRequestForm extends ConsumerWidget {
  final _VSControllerParams params;

  // final _ViewState state;
  // final _VSController stateController;
  const DiplomaticClubCardRequestForm({
    super.key,
    // required this.state,
    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Form(
          ...
          child: Column(
            children: [
              DiplomaticClubCardRequestHeader(
                onClose: () {
              ...
              KDropdownField<String>(
                value: null,
                fieldHeadingText: 'Request For *',
                hintText: 'Select Request For',

                items: stateController.requestFor
              ...
              KDropdownField<String>(
                value: null,
                fieldHeadingText: 'Membership Type *',
                hintText: 'Select Membership Type',

                items: stateController.membershipType
                    .map<KDropdownItem<String>>(
                      (opt) =>
                          KDropdownItem<String>(value: opt, child: Text(opt)),
                    )
              ...
              Padding(
                padding: EdgeInsets.only(bottom: 15.toAutoScaledHeight),
                child: KTextField(
                  fieldHeadingText: 'Organization Name',
              ...
              Padding(
                padding: EdgeInsets.only(bottom: 15.toAutoScaledHeight),
                child: KTextField(
                  fieldHeadingText: 'Subscription Amount',
...
class DiplomaticClubCardRequestHeader extends StatelessWidget {
  final String title;
  final String subtitle;
  final VoidCallback? onClose;

  const DiplomaticClubCardRequestHeader({
    super.key,
