...
part 'widgets/diplomatic_club_card_request_card.dart';
part 'widgets/diplomatic_club_card_request_form.dart';

@RoutePage()
class DiplomaticClubCardScreen extends ConsumerWidget {
  final List<SubServices> subServicesList;
  final int serviceId;
  late final _VSControllerParams params;

  DiplomaticClubCardScreen({
    super.key,
