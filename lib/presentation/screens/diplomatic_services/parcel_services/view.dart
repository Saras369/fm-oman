...
import 'package:code_setup/repository/domain/diplomatic_services/parcel_services_repo.dart';
...
part 'widgets/parcel_services_request_card.dart';
part 'widgets/parcel_services_requset_form.dart';

@RoutePage()
class ParcelServicesRequestScreen extends ConsumerWidget {
  final List<SubServices> subServicesList;
  final int serviceId;
  late final _VSControllerParams params;

  ParcelServicesRequestScreen({
    super.key,
