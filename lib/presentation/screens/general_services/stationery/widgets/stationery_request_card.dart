...
class StationeryRequestCard extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<StationeryRequestCard> createState() =>
      _StationeryRequestCardState();
}

class _StationeryRequestCardState extends ConsumerState<StationeryRequestCard> {
              ...
              children: [
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (_, index) => _StationeryRequestCardItem(
                      request: items[index],
...
class _StationeryRequestCardItem extends StatelessWidget {
  final StationeryMyRequestItem request;
  final _VSController stateController;

  const _StationeryRequestCardItem({
