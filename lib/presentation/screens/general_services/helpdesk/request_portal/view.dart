...
part 'widgets/help_desk_request_card.dart';
part 'widgets/help_desk_request_form.dart';

@RoutePage()
class HelpDeskRequestPortalScreen extends ConsumerWidget {
  final List<SubServices> subServicesList;
  final int serviceId;
  late final _VSControllerParams params;

  HelpDeskRequestPortalScreen({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final statsData = state.approvalKpiStats;
    ...
    return KScaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            StatSummaryRow(stats: stats, counts: ['0', '0', '0', '0']),
