...
import 'package:code_setup/repository/domain/diplomatic_services/register_vacancy_repo.dart';
import 'package:code_setup/utils/api_end_points.dart';
import 'package:code_setup/utils/app_extensions/app_extension.dart';
import 'package:dio/dio.dart';

class RegisterVacancyRepoImpl implements RegisterVacancyRepo {
  @override
  ...
  @override
  Future<void> createRegisterVacancyApproveRequest(
    Map<String, dynamic> data,
  ) async {
    try {
      final client = await KAppX.network.secureClient();
  ...
  @override
  Future<void> createRegisterVacancyRequest(Map<String, dynamic> data) async {
    try {
      final client = await KAppX.network.secureClient();
      if (client != null) {
        final response = await client.post(
