...
class StationeryRepoImpl implements StationeryRepo {
    ...
    try {
      ...
      if (client != null) {
        final response = await client.get(
          ApiEndPoint.stationeryApproverKPIStats,
        );
  ...
  Future<FinancialServicesTrendBreakdownData?> fetchMonthlyTrend(
    ...
    try {
      ...
      if (client != null) {
        final response = await client.get(
          isMyRequest
              ? ApiEndPoint.stationeryMonthlyTrend
              : ApiEndPoint.stationeryApproverMonthlyTrend,
  ...
  Future<FinancialStatusBreakdownData?> fetchStatusBreakdown(
    ...
    try {
      ...
      if (client != null) {
        final response = await client.get(
          isMyRequest
              ? ApiEndPoint.stationeryStatusBreakdown
              : ApiEndPoint.stationeryApproverStatusBreakdown,
          queryParameters: data,
        );
        if (response.statusCode == 200 && response.data != null) {
          final jsonMap = Map<String, dynamic>.from(response.data);
  ...
  @override
  Future<void> createStationeryRequest(Map<String, dynamic> data) async {
    try {
      final client = await KAppX.network.secureClient();
      if (client != null) {
        final response = await client.post(
          ApiEndPoint.stationeryCreateRequest,
          data: data,
        );
  ...
  Future<FinancialServicesStatsData?> fetchMyKPIStats() async {
    try {
      final client = await KAppX.network.secureClient();
      if (client != null) {
        final response = await client.get(ApiEndPoint.stationeryKPIStats);
        if (response.statusCode == 200 && response.data != null) {
          final jsonMap = Map<String, dynamic>.from(response.data);
          // Construct AttendanceData from JSON
  ...
  Future<void> createStationeryApproveApproveByFinanceRequest(
    ...
    try {
      ...
      if (client != null) {
        final response = await client.post(
          ApiEndPoint.stationeryApproveByFinanceRequest,
          data: data,
        );
        if ((response.statusCode == 200 || response.statusCode == 201) &&
            response.data != null) {
      ...
      log('error creating approve by fincance $e');
      throw ApiException(e.toString());
    }
  }

  @override
  Future<void> createStationeryApproveRequest(Map<String, dynamic> data) async {
    try {
      final client = await KAppX.network.secureClient();
      if (client != null) {
        final response = await client.post(
          ApiEndPoint.stationeryApproveRequest,
          data: data,
        );
        if ((response.statusCode == 200 || response.statusCode == 201) &&
            response.data != null) {
  ...
  Future<void> createStationeryAsssignToOfficeRequest(
    ...
    try {
      ...
      if (client != null) {
        final response = await client.post(
          ApiEndPoint.stationeryAssignToOffice,
          data: data,
        );
        if ((response.statusCode == 200 || response.statusCode == 201) &&
            response.data != null) {
  ...
  @override
  Future<List<StationeryMaterialItem>?> fetchStationeryMaterialItem() async {
    try {
      final client = await KAppX.network.secureClient();
      if (client != null) {
        final response = await client.get(
          ApiEndPoint.stationeryOfficeMaterials,
        );
        if (response.statusCode == 200 && response.data != null) {
          final jsonMap = Map<String, dynamic>.from(response.data);
          // Construct AttendanceData from JSON
          final materials = StationeryMaterialModel.fromJson(jsonMap).data;
          return materials;
        } else {
          final errorMessage =
              response.data?['message'] ?? 'Unexpected error occurred';
      ...
      log('error fetching stationery material $e');
      throw ApiException(e.toString());
    }
  }
  ...
  @override
  Future<List<StationeryOfficeItem>?> fetchStationeryOfficeItem() async {
    try {
      final client = await KAppX.network.secureClient();
      if (client != null) {
        final response = await client.get(ApiEndPoint.stationeryOfficesList);
        if (response.statusCode == 200 && response.data != null) {
          final jsonMap = Map<String, dynamic>.from(response.data);
          // Construct AttendanceData from JSON
          final offices = StationeryOfficeModel.fromJson(jsonMap).data;
          return offices;
        } else {
          final errorMessage =
              response.data?['message'] ?? 'Unexpected error occurred';
