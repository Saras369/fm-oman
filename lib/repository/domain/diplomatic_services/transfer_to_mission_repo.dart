...
import 'package:code_setup/repository/data/diplomatic_services/transfer_to_mission_repo_impl.dart';

abstract class TransferToMissionRepo {
  factory TransferToMissionRepo() => TransferToMissionRepoImpl();
  ...
  Future<void> createTransferToMissionRequest(Map<String, dynamic> data);
  Future<void> createTransferToMissionApproveRequest(Map<String, dynamic> data);
