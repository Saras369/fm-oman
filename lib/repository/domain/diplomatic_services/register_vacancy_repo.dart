...
import 'package:code_setup/repository/data/diplomatic_services/register_vacancy_repo_impl.dart';

abstract class RegisterVacancyRepo {
  factory RegisterVacancyRepo() => RegisterVacancyRepoImpl();
  ...
  Future<void> createRegisterVacancyRequest(Map<String, dynamic> data);
  Future<void> createRegisterVacancyApproveRequest(Map<String, dynamic> data);
